...
export default function Home() {
  ...
  return (
    <Wrapper>
      ...
      <ActionItems>
        <Header>
          <Image src={logo} height={130}></Image>
          <Profile>
...
bg-gray-200 flex-1 m-1 h-32 items-center justify-center rounded-lg transform hover:scale-105 transition text-xl curson-pointer
`
